if (D2RMM.getVersion == null || D2RMM.getVersion() < 1.8) {
    D2RMM.error('Requires D2RMM version 1.8 or higher.');
    return;
}
...
function addItemDictionaryToPauseMenu()
{
    ...
    {
        const buttonWidget = {
            type: "ToggleButtonWidget", "name": name,
            fields: {
                //"rect": { "x": 0, "y": 1150, "width": 452, "height": 105 },
                "filename": "PANEL\\Chronicle\\Btn_View_Rewards",
                "untoggledFrame": 0,
                "untoggledPressedFrame": 2,
                "untoggledHoveredFrame": 1,
                "untoggledDisabledFrame": 3,
                "toggledFrame": 0,
                "toggledPressedFrame": 2,
                "toggledHoveredFrame": 1,
                "onClickMessage": "PanelManager:OpenPanel:" + onClickMessage
            },
            children: [
                {
                    "type":"TextBoxWidget", "name": "ButtonText",
                    "fields": {
                        "text": textString,
                        "rect": { "x": 30, "y": 0, "width": 390, "height": 105 },
                        "style": {
                            "fontColor": "$FontColorLightTeal",
                            "pointSize": "$XMediumFontSize",
    ...
    const pauselayouthdFilenames = [
        {
            fileName: 'global\\ui\\layouts\\pauselayouthd.json',
            width: 560, rowHeight: 120, rectY: 150
        },
        {
            fileName: 'global\\ui\\layouts\\pauselayoutgardenhd.json',
            width: 540, rowHeight: 110, rectY: 420
        }
    ];
    pauselayouthdFilenames.forEach((file) => {
        const pauselayouthd = D2RMM.readJson(file.fileName);

        const itemDictionaryTableWidget = {
            "type": "TableWidget", "name": "PauseInfoTable",
            "fields": {
                "anchor": { "x": 0.5, "y": 0.5 },
                "rect": { "x": -file.width, "y": file.rectY },
                "columns": [
                    { "width": file.width, "alignment": { "h": "center", "v": "center" } },
                    { "width": file.width, "alignment": { "h": "center", "v": "center" } }
                    ],
                "rowHeight": file.rowHeight,
        ...
        D2RMM.writeJson(file.fileName, pauselayouthd);
    });
...
{"Key":"dictSetArcticFurs","koKR":"ÿc3방어력 +ÿcU(275-325)ÿc3% 증가\n모든 저항 +10\nÿc2냉기 저항 +15% (3 세트)\n방어력 +(3-297) (캐릭터 레벨에 비례) (2 세트)","enUS":"ÿc3+ÿcU(275-325)ÿc3% Enhanced Defense\nAll Resistances +10\nÿc2Cold Resist +15% (3 Items)\n+(3-297) Defense (Based on Character Level) (2 Items)"},
...
{"Key":"dictSetCiverbsCudgel","koKR":"ÿc3최대 피해 +ÿcU(17-23)ÿc3\n최대 피해 +(1-99) (캐릭터 레벨에 비례)\n명중률 +75\n언데드에게 주는 피해 +50%","enUS":"ÿc3+ÿcU(17-23)ÿc3 to Maximum Damage\n+(1-99) to Maximum Damage (Based on Character Level)\n+75 to Attack Rating\n+50% Damage to Undead"},
{"Key":"dictSetCiverbsWard","koKR":"ÿc3막기 확률 15% 증가\n방어력 +15\nÿc2독 저항 +ÿcU(25-26)ÿc2% (2 세트)\nÿc2마나 +ÿcU(21-22)ÿc2 (3 세트)","enUS":"ÿc315% Increased Chance of Blocking\n+15 Defense\nÿc2Poison Resist +ÿcU(25-26)ÿc2% (2 Items)\nÿc2+ÿcU(21-22)ÿc2 to Mana (3 Items)"},
...
{"Key":"dictSetNatalyasTotem","koKR":"ÿc3방어력 +ÿcU(135-175)ÿc3\n힘 +ÿcU(10-20)ÿc3\n민첩 +ÿcU(20-30)ÿc3\n모든 저항 +ÿcU(10-20)ÿc3\n마법 피해 3 감소","enUS":"ÿc3+ÿcU(135-175)ÿc3 Defense\n+ÿcU(10-20)ÿc3 to Strength\n+ÿcU(20-30)ÿc3 to Dexterity\nAll Resistances +ÿcU(10-20)ÿc3\nMagic Damage Reduced by 3"},
{"Key":"dictSetNatalyasMark","koKR":"ÿc3공격 속도 +40%\n피해 +200% 증가\n대상의 방어력 무시\n악마에게 주는 피해 +200%\n언데드에게 주는 피해 +200%\n화염 피해 12 - 17 추가\n냉기 피해 +50","enUS":"ÿc3+40% Increased Attack Speed\n+200% Enhanced Damage\nIgnore Target's Defense\n+200% Damage to Demons\n+200% Damage to Undead\nAdds 12-17 fire damage\n+50 cold damage"},
{"Key":"dictSetNatalyasShadow","koKR":"ÿc3그림자 단련 +2 (암살자 전용)\n방어력 +ÿcU(150-225)ÿc3\n생명력 +(1-99) (캐릭터 레벨에 비례)\n독 저항 +25%\n독 지속시간 75% 감소\n홈 있음 ÿcU(1-3)","enUS":"ÿc3+2 to Shadow Disciplines (Assassin Only)\n+ÿcU(150-225)ÿc3 Defense\n+(1-99) to Life (Based on Character Level)\nPoison Resist +25%\nPoison Length Reduced by 75%\nSocketed ÿcU(1-3)"},
{"Key":"dictSetNatalyasSoul","koKR":"ÿc3달리기/걷기 속도 +40%\n방어력 +ÿcU(75-125)ÿc3\n지구력 회복 속도 (0-24)% 증가 (캐릭터 레벨에 비례)\n냉기 저항 +ÿcU(15-25)ÿc3%\n번개 저항 +ÿcU(15-25)ÿc3%","enUS":"ÿc3+40% Faster Run/Walk\n+ÿcU(75-125)ÿc3 Defense\nHeal Stamina Plus (0-24)% (Based on Character Level)\nCold Resist +ÿcU(15-25)ÿc3%\nLightning Resist +ÿcU(15-25)ÿc3%"},
...
{"Key":"dictSetTalRashasLidlessEye","koKR":"ÿc3시전 속도 +20%\n+ÿcU(1-2)ÿc3 냉기 숙련 (원소술사 전용)\n+ÿcU(1-2)ÿc3 번개 숙련 (원소술사 전용)\n+ÿcU(1-2)ÿc3 화염 숙련 (원소술사 전용)\n마력 +10\n생명력 +57\n마나 +77\nÿc2냉기 기술 피해 +15% (5 세트)\n적의 번개 저항 -15% (4 세트)\n적의 화염 저항 -15% (3 세트)\n원소술사 기술 레벨 +1 (2 세트)","enUS":"ÿc3+20% Faster Cast Rate\n+ÿcU(1-2)ÿc3 to Cold Mastery (Sorceress Only)\n+ÿcU(1-2)ÿc3 to Lightning Mastery (Sorceress Only)\n+ÿcU(1-2)ÿc3 to Fire Mastery (Sorceress Only)\n+10 to Energy\n+57 to Life\n+77 to Mana\nÿc2+15% to Cold Skill Damage (5 Items)\n-15% to Enemy Lightning Resistance (4 Items)\n-15% to Enemy Fire Resistance (3 Items)\n+1 to Sorceress Skill Levels (2 Items)"},
...
{"Key":"dictSetTellingofBeads","koKR":"ÿc3모든 기술 +1\n냉기 저항 +18%\n독 저항 +ÿcU(35-50)ÿc3%\n공격자가 피해를 ÿcU(8-10)ÿc3 받음","enUS":"ÿc3+1 to All Skills\nCold Resist +18%\nPoison Resist +ÿcU(35-50)ÿc3%\nAttacker Takes Damage of ÿcU(8-10)"},
{"Key":"dictSetDarkAdherent","koKR":"ÿc3피격 시 25% 확률로 3 레벨 번개 파장 시전\n독 피해 24 - 34 추가 (2초에 걸쳐)\n방어력 +ÿcU(305-415)ÿc3\n화염 저항 +24%","enUS":"ÿc325% Chance to cast level 3 Nova when struck\nAdds 24-34 poison damage over 2 seconds\n+ÿcU(305-415)ÿc3 Defense\nFire Resist +24%"},
...
{"Key":"dictSetRiteofPassage","koKR":"ÿc3달리기/걷기 속도 +30%\n방어력 +25\n최대 지구력 +ÿcU(15-25)ÿc3\n빙결 지속시간 절반으로 감소","enUS":"ÿc3+30% Faster Run/Walk\n+25 Defense\n+ÿcU(15-25)ÿc3 Maximum Stamina\nHalf Freeze Duration"},
...
{"Key":"dictSetGriswoldsValor","koKR":"ÿc3방어력 +ÿcU(50-75)ÿc3% 증가\n모든 저항 +5\n냉기 피해 흡수 +(0-24) (캐릭터 레벨에 비례)\n마법 아이템 발견 확률 ÿcU(20-30)ÿc3% 증가\n착용 조건 -40%\n홈 있음 (2)\nÿc2공격 오라 +2 (성기사 전용) (2 세트)","enUS":"ÿc3+ÿcU(50-75)ÿc3% Enhanced Defense\nAll Resistances +5\n+(0-24) Absorbs Cold Damage (Based on Character Level)\nÿcU(20-30)ÿc3% Better Chance of Getting Magic Items\nRequirements -40%\nSocketed (2)\nÿc2+2 to Offensive Auras (Paladin Only) (2 Items)"},
{"Key":"dictSetGriswoldsRedemption","koKR":"ÿc3공격 속도 +40%\n피해 +ÿcU(200-240)ÿc3% 증가\n언데드에게 주는 피해 +250%\n착용 조건 -20%\n홈 있음 ÿcU(3-4)\nÿc2전투 기술 +2 (성기사 전용) (2 세트)\n피해 10 - 20 추가 (3 세트)\n피해 10 - 20 추가 (4 세트)","enUS":"ÿc3+40% Increased Attack Speed\n+ÿcU(200-240)ÿc3% Enhanced Damage\n+250% Damage to Undead\nRequirements -20%\nSocketed ÿcU(3-4)\nÿc2+2 to Combat Skills (Paladin Only) (2 Items)\nAdds 10-20 damage (3 Items)\nAdds 10-20 damage (4 Items)"},
...
{"Key":"dictSetBanesGarments","koKR":"ÿc4모든 기술 +1\n시전 속도 +25%\n피해 +80% 증가 (2 세트)\n민첩 +15\n마법 아이템 발견 확률 40% 증가","enUS":"ÿc4+1 to All Skills\n+25% Faster Cast Rate\n+80% Enhanced Damage (2 Items)\n+15 to Dexterity\n40% Better Chance of Getting Magic Items"},
{"Key":"dictSetBanesOathMaker","koKR":"ÿc3달리기/걷기 속도 +20%\n최대 피해 +(1-99) (캐릭터 레벨에 비례)\nÿc2치명적 공격 +30% (3 세트)\n적 처치 시 마나 +3 (2 세트)","enUS":"ÿc3+20% Faster Run/Walk\n+(1-99) to Maximum Damage (Based on Character Level)\nÿc2+30% Deadly Strike (3 Items)\n+3 to Mana after each Kill (2 Items)"},
{"Key":"dictSetBanesWraithskin","koKR":"ÿc3방어력 +50\n마법 저항 +30%\nÿc2명중률 +(8-792) (캐릭터 레벨에 비례) (3 세트)\n타격 회복 속도 +25% (2 세트)","enUS":"ÿc3+50 Defense\nMagic Resist +30%\nÿc2+(8-792) to Attack Rating (Based on Character Level) (3 Items)\n+25% Faster Hit Recovery (2 Items)"},
{"Key":"dictSetBanesAuthority","koKR":"ÿc3시전 속도 +10%\n생명력 +20\nÿc2마력 +15 (3 세트)","enUS":"ÿc3+10% Faster Cast Rate\n+20 to Life\nÿc2+15 to Energy (3 Items)"},
{"Key":"dictSetHorazonsSplendor","koKR":"ÿc4악마술사 기술 레벨 +3\n피해 +350% 증가\n+30 마법부여\n방어력 +300 (4 세트)\n민첩 +20 (2 세트)\n마력 +30 (3 세트)\n모든 저항 +50\n마법 아이템 발견 확률 100% 증가","enUS":"ÿc4+3 to Warlock Skill Levels\n+350% Enhanced Damage\n+30 to Enchant\n+300 Defense (4 Items)\n+20 to Dexterity (2 Items)\n+30 to Energy (3 Items)\nAll Resistances +50\n100% Better Chance of Getting Magic Items"},
{"Key":"dictSetHorazonsCountenance","koKR":"ÿc3악마술사 기술 레벨 +1\n명중률 보너스 (1-99)% (캐릭터 레벨에 비례)\n힘 +ÿcU(10-20)ÿc3\n마법 피해 ÿcU(7-10)ÿc3 감소\nÿc2힘 +15 (4 세트)\n최대 생명력 5% 증가 (2 세트)","enUS":"ÿc3+1 to Warlock Skill Levels\n(1-99)% Bonus to Attack Rating (Based on Character Level)\n+ÿcU(10-20)ÿc3 to Strength\nMagic Damage Reduced by ÿcU(7-10)\nÿc2+15 to Strength (4 Items)\nIncrease Maximum Life 5% (2 Items)"},
{"Key":"dictSetHorazonsDominion","koKR":"ÿc3악마 기술 +2 (악마술사 전용)\n방어력 +ÿcU(75-100)ÿc3% 증가\n마나 +ÿcU(75-100)ÿc3\n냉기 저항 +ÿcU(15-25)ÿc3%\n번개 저항 +ÿcU(15-25)ÿc3%\n화염 저항 +ÿcU(15-25)ÿc3%\nÿc2활력 +15 (4 세트)\n독 저항 +25% (2 세트)","enUS":"ÿc3+2 to Demon Skills (Warlock Only)\n+ÿcU(75-100)ÿc3% Enhanced Defense\n+ÿcU(75-100)ÿc3 to Mana\nCold Resist +ÿcU(15-25)ÿc3%\nLightning Resist +ÿcU(15-25)ÿc3%\nFire Resist +ÿcU(15-25)ÿc3%\nÿc2+15 to Vitality (4 Items)\nPoison Resist +25% (2 Items)"},
{"Key":"dictSetHorazonsHold","koKR":"ÿc3명중률 +ÿcU(95-150)ÿc3\n화염 피해 140 - 270 추가\n강타 확률 +10%\n민첩 +ÿcU(10-15)ÿc3\n생명력 +ÿcU(30-40)\nÿc2적중당 생명력 7% 훔침 (4 세트)\n적중당 마나 7% 훔침 (3 세트)\n공격 속도 +30% (2 세트)","enUS":"ÿc3+ÿcU(95-150)ÿc3 to Attack Rating\nAdds 140 - 270 fire damage\n+10% Chance of Crushing Blow\n+ÿcU(10-15)ÿc3 to Dexterityÿc3\n+ÿcU(30-40)ÿc3 to Life\nÿc27% Life stolen per hit (4 Items)\n7% Mana stolen per hit (3 Items)\n+30% Increased Attack Speed (2 Items)"},
{"Key":"dictSetHorazonsLegacy","koKR":"ÿc3달리기/걷기 속도 +30%\n힘 +ÿcU(10-15)ÿc3\n민첩 +ÿcU(10-15)ÿc3\n마법 저항 +ÿcU(20-30)ÿc3%\n빙결되지 않음\n착용 조건 -30%\nÿc2달리기/걷기 속도 +10% (2 세트)","enUS":"ÿc3+30% Faster Run/Walk\n+ÿcU(10-15)ÿc3 to Strength\n+ÿcU(10-15)ÿc3 to Dexterity\nMagic Resist +ÿcU(20-30)ÿc3%\nCannot Be Frozen\nRequirements -30%\nÿc2+10% Faster Run/Walk (2 Items)"},
{"Key":"dictSetHorazonsSecrets","koKR":"ÿc3기괴 기술 +2 (악마술사 전용)\n타격 회복 속도 +30%\n막기 확률 20% 증가\n활력 +ÿcU(20-30)ÿc3\n생명력 +ÿcU(30-50)\nÿc2마력 +15 (4 세트)\n적의 화염 저항 -25% (3 세트)\n독 지속시간 75% 감소 (2 세트)","enUS":"ÿc3+2 to Eldritch Skills (Warlock Only)\n+30% Faster Hit Recovery\n20% Increased Chance of Blocking\n+ÿcU(20-30)ÿc3 to Vitality\n+ÿcU(30-50)ÿc3 to Life\nÿc2+15 to Energy (4 Items)\n-25% to Enemy Fire Resistance (3 Items)\nPoison Length Reduced by 75% (2 Items)"},
{"Key":"dictNoticeSockets","koKR":"최대 홈 개수는 아이템 레벨 1~25 / 26~40 / 41이상 순서로 표시","enUS":"Max Sockets are Based on Item Level: 1-25 / 26-40 / 41+"},
{"Key":"dictNoticeBlockChance","koKR":"막기 확률은 성기사 / 야만용사, 아마존, 암살자, 악마술사 / 나머지 순서로 표시","enUS":"Block chance is in order: Paladin / Barb, Amazon, Assassin, Warlock / others."},
...
{"Key":"dictCraftHitPowerCommon","koKR":"ÿc3피격 시 5% 확률로 4 레벨 서릿발 시전\n공격자가 피해를 ÿcU(3-7)ÿc3 받음","enUS":"ÿc35% Chance to cast level 4 Frost Nova when struck\nAttacker Takes Damage of ÿcU(3-7)"},
{"Key":"dictCraftBloodCommon","koKR":"ÿc3적중당 생명력 ÿcU(1-3)ÿc3% 훔침\n생명력 +ÿcU(10-20)","enUS":"ÿcU(1-3)ÿc3% Life stolen per hit\n+ÿcU(10-20)ÿc3 to Life"},
{"Key":"dictCraftCasterCommon","koKR":"ÿc3마나 재생 ÿcU(4-10)ÿc3%\n마나 +ÿcU(10-20)","enUS":"ÿc3Regenerate Mana ÿcU(4-10)ÿc3%\n+ÿcU(10-20)ÿc3 to Mana"},
{"Key":"dictCraftSafetyCommon","koKR":"ÿc3마법 피해 ÿcU(1-2)ÿc3 감소\n피해 ÿcU(1-4)ÿc3 감소","enUS":"ÿc3Magic Damage Reduced By ÿcU(1-2)ÿc3\nDamage Reduced By ÿcU(1-4)"},
{"Key":"dictCraftHitPowerCommon","koKR":"ÿc3피격 시 5% 확률로 4 레벨 서릿발 시전\n공격자가 피해를 ÿcU(3-7)ÿc3 받음","enUS":"ÿc35% Chance to cast level 4 Frost Nova when struck\nAttacker Takes Damage of ÿcU(3-7)"},
{"Key":"dictCraftBloodCommon","koKR":"ÿc3적중당 생명력 ÿcU(1-3)ÿc3% 훔침\n생명력 +ÿcU(10-20)","enUS":"ÿcU(1-3)ÿc3% Life stolen per hit\n+ÿcU(10-20)ÿc3 to Life"},
{"Key":"dictCraftCasterCommon","koKR":"ÿc3마나 재생 ÿcU(4-10)ÿc3%\n마나 +ÿcU(10-20)","enUS":"ÿc3Regenerate Mana ÿcU(4-10)ÿc3%\n+ÿcU(10-20)ÿc3 to Mana"},
{"Key":"dictCraftSafetyCommon","koKR":"ÿc3마법 피해 ÿcU(1-2)ÿc3 감소\n피해 ÿcU(1-4)ÿc3 감소","enUS":"ÿc3Magic Damage Reduced By ÿcU(1-2)ÿc3\nDamage Reduced By ÿcU(1-4)"},
{"Key":"dictCredit","koKR":"아이템 사전 모드 ver 2.12\nCreated by 강낭땅콩","enUS":"Item Dictionary Mod ver 2.12\nCreated by jeffjks"},
{"Key":"dictLadderOnly","koKR":"(래더 전용)","enUS":"(Ladder Only)"},
{"Key":"dictStandardOnly","koKR":"(스탠다드 전용)","enUS":"(Standard Only)"},
{"Key":"dictNeedRotW","koKR":"(악마술사의 군림 필요)","enUS":"(Need RotW)"},
{"Key":"dictMaxSocketNumber","koKR":"ÿc3최대 홈 개수","enUS":"ÿc3Max Sockets"},
{"Key":"dictVariable","koKR":"ÿcU(변함)","enUS":"ÿcU(Varies)"},
{"Key":"dictTextNormalWeapons","koKR":"일반 무기","enUS":"Normal Weapons"},
{"Key":"dictTextNormalArmors","koKR":"일반 방어구","enUS":"Normal Armors"},
{"Key":"dictTextUniqueWeapons","koKR":"유니크 무기","enUS":"Unique Weapons"},
{"Key":"dictTextUniqueArmors","koKR":"유니크 방어구/기타","enUS":"Unique Armors/Misc"},
{"Key":"dictTextRunewords","koKR":"룬어 아이템","enUS":"Runewords"},
{"Key":"dictTextSetItems","koKR":"세트 아이템","enUS":"Set Items"},
{"Key":"dictTextCubeRecipes","koKR":"큐브 조합법","enUS":"Cube Recipes"},
{"Key":"dictTooltipCubeRecipes","koKR":"큐브 조합법 창 열기","enUS":"Open Cube Recipes"},
{"Key":"dictCraftAdditionalProperties","koKR":"ÿcU외 추가 속성 최대 4개","enUS":"ÿcUUp to 4 Random Prefixes/Suffixes"},
...
{"Key":"dictSmiteDmg","koKR":"강타 피해","enUS":"Smite Dmg"},
{"Key":"dictKickDmg","koKR":"발차기 피해","enUS":"Kick Dmg"},
{"Key":"dictOneHandDmg","koKR":"한손 피해","enUS":"One-Hand Dmg"},
{"Key":"dictTwoHandDmg","koKR":"양손 피해","enUS":"Two-Hand Dmg"},
{"Key":"dictThrowDmg","koKR":"투척 피해","enUS":"Throw Dmg"},
...
{"Key":"dictClassGrimoire","koKR":"악마술사 전용 방패","enUS":"Grimoire"},
